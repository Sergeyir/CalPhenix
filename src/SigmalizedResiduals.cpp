...
// Mode2 analyzes track residual variables for the specific detector, variable, and particle
...
{   
   ...
   for (const Json::Value& particle : calibrationInput["particles_to_calibrate"])
   {
